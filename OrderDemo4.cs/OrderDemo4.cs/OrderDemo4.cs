...
namespace OrderDemo4.cs
{
    ...
    public class ShippedOrder : Order,IComparable 
    {
        public const double SHIPPING_FEE = 4.00;
        ...
        public new int QuantityOrdered
        {
            get
            {
                return quantityOrdered;
            ...
            {
                quantityOrdered = value;
                totalPrice = ((quantityOrdered * UNIT_PRICE) + SHIPPING_FEE);
            }
        }
        ...
        {
            int returnVal;
            ShippedOrder  temp = (ShippedOrder )o;
